...
const faqs = [
  {
    ...
    answer:
      '4대보험은 국민연금, 건강보험, 장기요양보험, 고용보험을 말합니다. 근로자와 사업주가 각각 일정 비율을 부담하며, 본 계산기는 근로자 부담분만 계산합니다. 2026년 기준 근로자 부담 합계는 약 9.72%입니다.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '네, 국민연금은 소득월액 상한이 있습니다. 2026년 기준 상한 소득월액은 637만원으로, 월 소득이 이를 초과하더라도 637만원 기준으로 보험료가 산정됩니다.',
  },
];
