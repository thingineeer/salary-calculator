...
export const metadata: Metadata = {
  ...
  description:
    '2026년 기준 연봉을 시급·일급으로 자동 변환! 시급에서 연봉 역산도 가능. 세전·세후 시급 비교, 최저시급(10,320원) 대비 몇 배인지 확인하세요.',
  keywords:
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '2026년 최저시급은 10,320원입니다. 월 소정근로시간 209시간 기준 월 최저임금은 약 2,156,880원이며, 연봉으로 환산하면 약 25,882,560원입니다.',
        },
      },
      {
        '@type': 'Question',
